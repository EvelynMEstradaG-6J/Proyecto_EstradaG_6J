...
class AtencionClienteWidget extends StatefulWidget {
  const AtencionClienteWidget({Key key}) : super(key: key);

  @override
  _AtencionClienteWidgetState createState() => _AtencionClienteWidgetState();
}

class _AtencionClienteWidgetState extends State<AtencionClienteWidget> {
              ...
              Align(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Image.network(
                        'https://raw.githubusercontent.com/EvelynMEstradaG-6J/Proyecto_UIII_Estrada_Gallegos_6J/main/AtencionCliente.jpg',
                        width: 400,
                        height: 230,
                        fit: BoxFit.cover,
                      ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          'envía tu reporte y resolveremos tus dudas',
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context).bodyText1.override(
                                fontFamily: 'Open Sans Condensed',
